...
//Adminen och Projektchefens behörigheter
    ...
    private void sattBehorighet() {
        ...
        if (arAdmin) {
          ...
          boolean farSeCombo = arAdmin || arProjektchef || arHandlaggare;

          cbPartners.setVisible(farSeCombo);
          lblProjektitel.setVisible(farSeCombo);
   ...
   private void fyllPartnersTabell() {
    ...
    if (arAdmin || arProjektchef || arHandlaggare) {
        ...
        if (projektPid != null) {
            lista = Partners.hamtaForProjekt(idb, projektPid);
        }
    }
    ...
    private void initComponents() {
        ...
        btnAndraPartners.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnAndraPartners.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnTabortPartners.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        btnLaggtillPartners.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnLaggtillPartners.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnTbPartners.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnTbPartners.setForeground(new java.awt.Color(255, 255, 255));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnTbPartners, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
